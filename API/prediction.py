...
class GovernanceInput(BaseModel):
    Q20: float = Field(..., ge=0, le=8, description="Trust in local government (0–10)")
    Q21A: float = Field(..., ge=0, le=8)
    Q24: float = Field(..., ge=0, le=8)
    Q34A: float = Field(..., ge=0, le=8)
    Q26: float = Field(..., ge=0, le=8)
    Q28: float = Field(..., ge=0, le=8)
    Q32A: float = Field(..., ge=0, le=8)
    Q32B: float = Field(..., ge=0, le=8)
    Q48A: float = Field(..., ge=0, le=8)
    Q48B: float = Field(..., ge=0, le=8)
    Q50A: float = Field(..., ge=0, le=8)
    Q50B: float = Field(..., ge=0, le=8)
    Q50C: float = Field(..., ge=0, le=8)
    Q51A: float = Field(..., ge=0, le=8)
    Q51B: float = Field(..., ge=0, le=8)
    Q53A: float = Field(..., ge=0, le=8)
    Q53B: float = Field(..., ge=0, le=8)
    Q53C: float = Field(..., ge=0, le=8)
    Q35A: float = Field(..., ge=0, le=8)
    Q36A: float = Field(..., ge=0, le=8)
    Q38A: float = Field(..., ge=0, le=8)
    Q38B: float = Field(..., ge=0, le=8)
    Q38C: float = Field(..., ge=0, le=8)
